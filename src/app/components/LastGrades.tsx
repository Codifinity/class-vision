...
export default function LastGrades() {
  return (
    <section className=" border-gray-300 border-[1px] rounded-lg lg:w-5/12 lg:ml-10 mt-4 w-full shadow-md">
          ...
          {subject === grade.subjectName ? (
            <div
              className={`flex justify-center items-center ${
                ...
                grade.type === "Inne" ? "bg-[#3398734D] text-[#339873] rounded-md px-1 w-6 mt-0.5" : ""
              } `}
            >
