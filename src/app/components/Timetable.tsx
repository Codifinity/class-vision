  ...
  return (
    <section className="border-gray-300 border-[1px] lg:w-1/4 w-full mx-auto rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md">
      <div className="flex flex-row items-center justify-between">
        <h3 className="text-dark-blue font-raleway-bold text-2xl">
          Plan lekcji
        </h3>
        <div
      ...
      {isOpen ? (
        <>
          <div className="mt-5">
            <p className="text-lg font-raleway-semibold">Dzisiaj: </p>
            <div className="flex flex-col justify-center items-start mt-2">
              <TimetableItem lessons={today} />
            </div>
          </div>
          <div className="mt-5">
            <p className="text-lg font-raleway-semibold">Jutro: </p>
            <div className="flex flex-col justify-center items-start mt-2">
    ...
    <>
      {lessons.map((lesson, lessonId) => (
        <div
          ...
          key={lessonId}
        >
          <div className="flex justify-center items-center bg-dark-blue text-white font-raleway-regular rounded-s-xl w-10 py-1">
            <p>{lessonId + 1}</p>
          </div>
          <div className="flex justify-start w-8/12 items-center font-raleway-medium">
            <p>{lesson.name}</p>
          </div>
          <div className="w-32">
            <p>
