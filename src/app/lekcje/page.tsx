    ...
    <div className="w-full">
      ...
      <section className="border-gray-300 border-[1px] lg:w-auto mx-3 w-auto rounded-lg px-5 lg:my-4 mt-8 py-8 shadow-md ">
        <div className="flex flex-row items-center justify-between my-2 mb-3 mx-3">
          <h3 className="text-black font-bold text-2xl">Plan lekcji</h3>
        </div>
        <div className="grid lg:grid-cols-3 grid-cols-1 md:grid-cols-2 md:mx-0 gap-x-2 gap-y-8 lg:mx-2">
          <div className="border-gray-300 border-[1px] rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md lg:mx-3 mx-1">
            <p className="text-lg font-semibold">Poniedziałek: </p>
            <div className="flex flex-col justify-center items-start mt-2 ">
              <TimetableItem lessons={monday} />
            </div>
          </div>
          <div className="border-gray-300 border-[1px] rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md lg:mx-3 mx-1">
            <p className="text-lg font-semibold">Wtorek: </p>
            <div className="flex flex-col justify-center items-start mt-2">
              <TimetableItem lessons={tuesday} />
            </div>
          </div>
          <div className="border-gray-300 border-[1px] rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md lg:mx-3 mx-1">
            <p className="text-lg font-semibold">Środa: </p>
            <div className="flex flex-col justify-center items-start mt-2">
              <TimetableItem lessons={wednesday} />
            </div>
          </div>
          <div className="border-gray-300 border-[1px]  rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md lg:mx-3 mx-1">
            <p className="text-lg font-semibold">Czwartek: </p>
            <div className="flex flex-col justify-center items-start mt-2">
              <TimetableItem lessons={thursday} />
            </div>
          </div>
          <div className="border-gray-300 border-[1px] rounded-lg px-5 lg:mt-0 mt-4 py-8 shadow-md lg:mx-3 mx-1">
            <p className="text-lg font-semibold">Piątek: </p>
            <div className="flex flex-col justify-center items-start mt-2">
